...
*활성* 의 정의는 제품마다 다릅니다. *앱 열기* 만으로 활성으로 보는 경우, *의미 있는 행동을 한 경우*, *세션 시간이 N초 이상* 등이 있습니다.
...
DAU와 달리 *매일 들어올 필요는 없습니다*. 7일 중 한 번이라도 들어오면 카운트합니다.
...
산업·서비스 전반의 *규모* 를 묘사하는 가장 보편적 지표입니다.
...
DAU 100K에 세션 240K이면 Average Session = 2.4. *하루에 평균 2.4번 들어옵니다*.
