...
![로깅의 양면 - 보안에 도움되는 로그와 위험한 로그](sec-05-01-logging-do-dont.svg)
...
![탐지부터 복구까지의 시간 흐름과 핵심 지표](sec-05-02-detection-timeline.svg)
...
![Incident Response Playbook의 단계](sec-05-05-incident-response-playbook.svg)
...
![Fail Closed vs Fail Open 결정 매트릭스](sec-05-03-fail-closed-vs-open.svg)
...
![Circuit Breaker 상태 머신](sec-05-04-circuit-breaker.svg)
