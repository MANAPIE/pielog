...
![데이터 보호의 다층 방어 구조](sec-02-01-data-protection-layers.svg)
...
![보안 헤더가 막는 공격들](sec-02-03-security-headers-map.svg)
...
![해시, 암호화, HMAC의 차이](sec-02-02-hash-vs-encryption.svg)
...
![빠른 해시와 느린 해시의 GPU 공격 저항성 비교](sec-02-04-bcrypt-slowness.svg)
...
![자주 발생하는 클라우드 설정 오류 유형](sec-02-05-cloud-misconfig.svg)
