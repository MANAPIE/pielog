...
![공급망 공격 경로](sec-04-01-supply-chain-vectors.svg)
...
![SBOM 생성과 활용 흐름](sec-04-02-sbom-flow.svg)
...
![Dependabot/Renovate 워크플로우](sec-04-03-dependency-automation.svg)
...
![STRIDE 위협 모델링 프레임워크](sec-04-04-stride-threat-modeling.svg)
...
![비즈니스 로직 악용 패턴](sec-04-05-business-logic-exploit.svg)
