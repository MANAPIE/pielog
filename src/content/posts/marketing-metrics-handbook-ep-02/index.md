...
- **디자인**: MER 자체는 디자인의 직접 책임이 아니지만, *오가닉 트래픽(organic traffic)을 키우는 디자인*이 MER 분자를 키웁니다. SEO 최적화, 공유 가능한 콘텐츠, 입소문 유도가 여기 해당합니다.
...
ROAS는 *광고 매니저가 자기 광고에 귀속한 매출만* 봅니다. MER은 *모든 매출 ÷ 모든 마케팅 비용*입니다. 채널이 많아질수록 ROAS 합산과 MER이 어긋납니다. 어트리뷰션 충돌의 신호입니다.

### ROAS vs iROAS

리타기팅 캠페인은 ROAS 800%, iROAS 120%처럼 6배 이상 차이가 나는 경우가 흔합니다. *광고를 안 봤어도 살 사람* 이 그만큼 많기 때문입니다. 신규 획득 캠페인은 두 수치 차이가 작습니다.
...
광고비가 화면에 닿고 사용자가 우리 영역으로 넘어왔습니다. 이 첫 1분에는 클릭률, 전환율, 이탈, 스크롤 깊이 같은 일들이 일어납니다. 12개 용어를 다룹니다.
