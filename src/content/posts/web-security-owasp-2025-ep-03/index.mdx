...
![신뢰 경계 다이어그램](sec-03-01-trust-boundary.svg)
...
![SQL Injection - String concat과 Prepared Statement 비교](sec-03-02-sql-injection.svg)
...
![XSS의 세 가지 유형](sec-03-03-xss-types.svg)
...
![JSON과 Pickle의 차이](sec-03-04-deserialization.svg)
...
![SRI를 통한 공급망 변조 방어](sec-03-05-sri-defense.svg)
