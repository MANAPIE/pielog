...
*Logo* 는 B2B 맥락의 어휘입니다. 이는 *기업 고객의 로고가 하나 없어졌다* 는 비유입니다.
...
NRR 110%는 *기존 고객 100명이 떠난 사람을 빼고도 110의 매출을 만들었다* 는 뜻입니다. 가장 강력한 SaaS 지표입니다.
...
N의 기준은 보통 30일·60일·90일입니다. 제품마다 다릅니다.
...
사용자가 *명시적으로 해지한* 이탈. 가격, 기능 부족, 경쟁사 이동 등 *의도된* 사유입니다.
...
사용자가 *떠나려는 의도 없이* 발생한 이탈. 가장 흔한 사유는 *카드 결제 실패*입니다. 외에 만료된 카드, 한도 초과, 카드 변경 후 미갱신 등이 있습니다.
...
차이가 크면 *확장으로 이탈을 가리고 있다*. 두 수치를 함께 보고 *확장에 의존하는가 vs 진짜 유지가 강한가* 를 판단합니다.
